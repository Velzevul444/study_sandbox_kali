...
import { registerRequest, saveToken } from '../api';
  ...
  return (
    <div className="mx-auto max-w-md rounded-[32px] border border-white/10 bg-slate-900/95 p-10 shadow-[0_32px_90px_-60px_rgba(0,0,0,0.9)]">
      <div className="mb-6 space-y-2">
        <p className="text-sm uppercase tracking-[0.25em] text-[#FF3D57]/80">Регистрация</p>
        <h1 className="text-3xl font-semibold text-white">Создайте аккаунт</h1>
        <p className="text-[#BFC7D2]">Зарегистрируйтесь, чтобы перейти ко всем уровням и писать свои атаки.</p>
      </div>
